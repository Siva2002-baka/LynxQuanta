...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'nav2_brain = lynx_quanta.navigation_brain:main',
            'yolo_node = lynx_quanta.perception.yolo_node:main',
            'yolo_node_onr = lynx_quanta.perception.yolo_node_onr:main',
            'chair_push_node = lynx_quanta.perception.chair_push_node:main',
        ],
    },
)
